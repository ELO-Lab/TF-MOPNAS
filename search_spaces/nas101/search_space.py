...
from search_spaces.nas101.utils import CONV1X1, CONV3X3, MAXPOOL3X3, INPUT, OUTPUT, upscale_to_nasbench_format
from search_spaces.nas101.utils import parent_combinations as parent_combinations_old
