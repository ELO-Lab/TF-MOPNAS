...
def mo_ops_prune(search_space, tf_ind, path_data, path_results, seed):
...
def main(kwargs):
    ...
    for run_i in range(n_runs):
        ...
        s = time.time()
        edge_matrix_lst, ops_matrix_lst = mo_ops_prune(tf_ind=tf_metric, search_space=search_space,
        ...
        IGD = -1000
        if evaluate_mode:
            IGD = evaluate(edge_matrix_final=edge_matrix_lst,
        ...
        with open(f'{path_results_}/logging.txt', 'w') as f:
            ...
            f.write(f'- Executed Time: {executed_time}\n')
            f.write(f'- IGD: {IGD}\n')
